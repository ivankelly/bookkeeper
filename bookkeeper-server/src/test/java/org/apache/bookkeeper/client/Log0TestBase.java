...
public class Log0TestBase {
    static final Logger LOG = LoggerFactory.getLogger(Log0TestBase.class);
    ...
    public Log0TestBase(int numBookies) {
    ...
    List<BookieSocketAddress> getBookieAddresses() throws Exception {
        List<BookieSocketAddress> bookies = new ArrayList<>();
        for (BookieServer server : bs) {
            bookies.add(server.getLocalAddress());
        }
        return bookies;
    }
}
