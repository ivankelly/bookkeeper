...
import org.apache.bookkeeper.client.BookKeeperClientStats.ClientCounter;
...
public class LedgerHandle {
    ...
    LedgerHandle(BookKeeper bk, long ledgerId, LedgerMetadata metadata,
        ...
        ensembleChangeCounter = bk.getStatsLogger().getCounter(ClientCounter.NUM_ENSEMBLE_CHANGE);
        bk.getStatsLogger().registerGauge(ClientCounter.NUM_PENDING_ADD,
                                          new Gauge<Integer>() {
