...
import static org.apache.bookkeeper.stats.Stats.name;
...
public class LedgerHandle {
    ...
    LedgerHandle(BookKeeper bk, long ledgerId, LedgerMetadata metadata,
        ...
        ensembleChangeCounter = bk.getStatsLogger().getCounter(name(LedgerHandle.class, "ensemble-changes"));
        bk.getStatsLogger().registerGauge(name(LedgerHandle.class, "pending-add-ops"),
                                          new Gauge<Integer>() {
