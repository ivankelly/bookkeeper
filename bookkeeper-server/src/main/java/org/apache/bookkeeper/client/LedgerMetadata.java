...
public class LedgerMetadata implements org.apache.bookkeeper.client.api.LedgerMetadata {
    ...
    private final TreeMap<Long, ImmutableList<BookieSocketAddress>> ensembles;
    ...
    LedgerMetadata(int metadataFormatVersion,
        ...
        this.ensembles = ensembles.entrySet().stream()
            .collect(TreeMap::new,
    ...
    LedgerMetadataFormat buildProtoFormat(boolean withPassword) {
        ...
        ctime.ifPresent(t -> builder.setCtime(t));
    ...
    public static LedgerMetadata parseConfig(byte[] bytes,
                                             java.util.Optional<Long> legacyCtime) throws IOException {
        ...
        if (data.hasCtime()) {
            ...
            legacyCtime.ifPresent(t -> builder.withLegacyCreationTime(t));
        }
        ...
        for (LedgerMetadataFormat.Segment s : data.getSegmentList()) {
            ...
            for (String a : s.getEnsembleMemberList()) {
                addrs.add(new BookieSocketAddress(a));
            }
