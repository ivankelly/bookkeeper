...
public class HTTPStatsExporter {
    ...
    public void start() throws Exception {
        ...
        TimeSeriesRepository sampler = new TimeSeriesRepositoryImpl(
                com.twitter.common.stats.Stats.STAT_REGISTRY,
        ...
        Supplier<Iterable<Stat<?>>> supplier = new Supplier<Iterable<Stat<?>>>() {
            ...
            public Iterable<Stat<?>> get() {
                return com.twitter.common.stats.Stats.getVariables();
            }
        };
